...
packer = Packer()
#  init bin
box = Bin(partno='example3', width=6, height=1, depth=5, max_weight=100, corner=0, bin_type=1)
#  add item
...
packer.add_item(Item(partno='Box-1', name='test', typeof='cube', width=2, height=1,
                depth=3, weight=1, level=1, loadbear=100, upside_down_=True, color='yellow'))
packer.add_item(Item(partno='Box-2', name='test', typeof='cube', width=3, height=1, depth=2, weight=1, level=1,
                loadbear=100, upside_down_=True, color='pink'))  # Try switching WHD=(3, 1, 2) and (2, 1, 3) to compare the results
packer.add_item(Item(partno='Box-3', name='test', typeof='cube', width=2, height=1,
                depth=3, weight=1, level=1, loadbear=100, upside_down_=True, color='brown'))
packer.add_item(Item(partno='Box-4', name='test', typeof='cube', width=2, height=1,
                depth=3, weight=1, level=1, loadbear=100, upside_down_=True, color='cyan'))
